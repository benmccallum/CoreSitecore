...
namespace CoreSitecore.Sys.ComponentModel
{
    ...
    public class ScMaxLengthAttribute : MaxLengthAttribute, IClientValidatable
    {
        ...
        /// <summary>
        /// Initializes a MaxLength attribute that gets its error message from the Sitecore Dictionary using <paramref name="dictionaryKey"/>.
        /// </summary>
        /// <param name="dictionaryKey">Key to lookup in Sitecore Dictionary.</param>
        public ScMaxLengthAttribute(string dictionaryKey)
        {
        ...
        /// <param name="dictionaryKey">Key to lookup in Sitecore Dictionary.</param>
        public ScMaxLengthAttribute(int length, string dictionaryKey)
        {
            _dictionaryKey = dictionaryKey;
        }
