...
namespace CoreSitecore.Sys.ComponentModel
{
    ...
    public class ScRequiredAttribute : RequiredAttribute, IClientValidatable
    {
        ...
        /// <summary>
        /// Initializes a Required field attribute that gets its error message from the Sitecore Dictionary using <paramref name="dictionaryKey"/>.
        /// </summary>
        /// <param name="dictionaryKey">Key to lookup in Sitecore Dictionary.</param>
        public ScRequiredAttribute(string dictionaryKey)
        {
